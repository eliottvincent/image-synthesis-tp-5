...
class Ground extends Mesh
{
    ...
    constructor()
    {
        ...
        // ajout des sommets
        let P1 = new Vertex(this, -8.0, 0.0, +8.0).setTexCoords(0.0, 0.0);
        let P2 = new Vertex(this, +8.0, 0.0, +8.0).setTexCoords(8.0, 0.0);
        let P3 = new Vertex(this, +8.0, 0.0, -8.0).setTexCoords(8.0, 8.0);
        let P4 = new Vertex(this, -8.0, 0.0, -8.0).setTexCoords(0.0, 8.0);
