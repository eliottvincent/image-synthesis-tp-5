...
class Scene
{
    ...
    onDrawFrame()
    {
        ...
        mat4.translate(this.m_MatV, this.m_MatV, vec3.fromValues(0.0, -0.25, -this.m_Distance));
        ...
        // dessiner le rocher
        mat4.scale(this.m_MatV, this.m_MatV, vec3.fromValues(0.4, 0.4, 0.4));
        this.m_Rock.onDraw(this.m_MatP, this.m_MatV);
    }
